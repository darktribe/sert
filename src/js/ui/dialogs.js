...
export async function showNewFileDialog() {
    return new Promise((resolve) => {
        const dialogOverlay = createDialogOverlay('new-file-dialog-overlay');
        ...
        const dialog = createDialog(`
            ...
            <div style="display: flex; gap: 10px; justify-content: flex-end;">
                <button id="save-and-new-btn" tabindex="1" style="${getButtonStyle('#0e639c')}">保存して新規作成</button>
                <button id="new-without-saving-btn" tabindex="2" style="${getButtonStyle('#d14949')}">保存せずに新規作成</button>
                <button id="cancel-new-btn" tabindex="3" style="${getButtonStyle('#5a5a5a')}">キャンセル</button>
            </div>
        `);
...
export async function showOpenFileDialog() {
    return new Promise((resolve) => {
        const dialogOverlay = createDialogOverlay('open-file-dialog-overlay');
        ...
        const dialog = createDialog(`
            ...
            <div style="display: flex; gap: 10px; justify-content: flex-end;">
                <button id="save-and-open-btn" tabindex="1" style="${getButtonStyle('#0e639c')}">保存してから開く</button>
                <button id="open-without-saving-btn" tabindex="2" style="${getButtonStyle('#d14949')}">保存せずに開く</button>
                <button id="cancel-open-btn" tabindex="3" style="${getButtonStyle('#5a5a5a')}">キャンセル</button>
            </div>
        `);
...
export async function showExitDialog() {
    return new Promise((resolve) => {
        const dialogOverlay = createDialogOverlay('exit-dialog-overlay');
        ...
        const dialog = createDialog(`
            ...
            <div style="display: flex; gap: 10px; justify-content: flex-end;">
                <button id="save-and-exit-btn" tabindex="1" style="${getButtonStyle('#0e639c')}">保存して終了</button>
                <button id="exit-without-saving-btn" tabindex="2" style="${getButtonStyle('#d14949')}">保存せずに終了</button>
                <button id="cancel-exit-btn" tabindex="3" style="${getButtonStyle('#5a5a5a')}">キャンセル</button>
            </div>
        `);
